/* =========================================================
   이벤트 성과 — 공통 모듈
   샘플 데이터 · 집계(백분위 → 하위 30% → TOP 5) · 이벤트 상세 드로어
   데일리 리포트(index.html)와 성과 조회(search.html)가 함께 쓴다.
   성과는 이벤트 등록 화면의 대분류(국내도서·외국도서·음반,DVD·GIFT·eBook) 단위로 비교한다.
   기준일(전일) = 2026-09-17
   ========================================================= */
...
/* ---------------------------------------------------------
   ...
   --------------------------------------------------------- */
const EVENTS = [
  { id: 'EV24091', c: '국내도서', n: '9월 로맨스 신작 릴레이',      f: '로맨스',        md: '이지은', s: '2026-09-01', rev: 11450000, ord: 1880, uv: 28600, nb: 402, aRev: 8900000, aOrd: 1520, aUv: 25400, aNb: 355 },
  { id: 'EV24102', c: 'eBook', n: '전자책 단독 선출간 기획전',    f: '소설',          md: '박서준', s: '2026-09-05', rev:  8640000, ord: 1120, uv: 19800, nb: 265, aRev: 7950000, aOrd: 1060, aUv: 18900, aNb: 240 },
  { id: 'EV23887', c: '국내도서', n: '가을 에세이 북페어',           f: '에세이',        md: '김하늘', s: '2026-08-28', rev:  2140000, ord:  420, uv: 11300, nb:  88, aRev: 2380000, aOrd:  455, aUv: 11900, aNb:  96 },
  { id: 'EV24140', c: '국내도서', n: '경제경영 베스트 반값',         f: '경제경영',      md: '최우식', s: '2026-09-10', rev:  3860000, ord:  640, uv: 14200, nb: 141, aRev: 3420000, aOrd:  580, aUv: 13100, aNb: 128 },
  { id: 'EV24118', c: '국내도서', n: '자기계발 루틴 챌린지',         f: '자기계발',      md: '김하늘', s: '2026-09-08', rev:  1720000, ord:  310, uv: 12800, nb:  74, aRev: 1880000, aOrd:  336, aUv: 13400, aNb:  82 },
  { id: 'EV23801', c: '국내도서', n: '판타지 완결작 정주행',         f: '판타지',        md: '정유미', s: '2026-08-20', rev:  4520000, ord:  980, uv: 16700, nb: 112, aRev: 4180000, aOrd:  900, aUv: 15900, aNb: 105 },
  { id: 'EV24177', c: '국내도서', n: '라이트노벨 신간 3종 세트',     f: '만화/라노벨',   md: '정유미', s: '2026-09-14', rev:  6240000, ord: 1640, uv: 22900, nb: 198, aRev: 5700000, aOrd: 1490, aUv: 21600, aNb: 186 },
  { id: 'EV24156', c: '국내도서', n: 'IT 개발서 30% 쿠폰',           f: 'IT',            md: '최우식', s: '2026-09-12', rev:  2560000, ord:  330, uv:  6400, nb:  58, aRev: 2310000, aOrd:  298, aUv:  6050, aNb:  54 },
  { id: 'EV24095', c: '국내도서', n: '인문 고전 다시 읽기',          f: '인문',          md: '박서준', s: '2026-09-02', rev:   690000, ord:   95, uv:  8900, nb:  18, aRev:  820000, aOrd:  112, aUv:  9400, aNb:  22 },
  { id: 'EV23412', c: 'eBook', n: '어린이 전자책 여름방학',       f: '어린이/청소년', md: '이지은', s: '2026-07-25', rev:   180000, ord:   42, uv:  3900, nb:   9, aRev:  240000, aOrd:   55, aUv:  4600, aNb:  12 },
  { id: 'EV24182', c: 'eBook', n: '크레마클럽 신규 가입 이벤트',  f: '종합',          md: '김하늘', s: '2026-09-15', rev:  9720000, ord: 1510, uv: 33400, nb: 890, aRev: 6400000, aOrd: 1020, aUv: 24800, aNb: 612 },
  { id: 'EV24190', c: 'eBook', n: '추석 연휴 몰아보기 팩',        f: '종합',          md: '최우식', s: '2026-09-16', rev: 14820000, ord: 2140, uv: 41200, nb: 612, aRev: 9800000, aOrd: 1430, aUv: 29600, aNb: 430 },
  { id: 'EV24108', c: '국내도서', n: '미스터리·스릴러 특별전',       f: '소설',          md: '박서준', s: '2026-09-06', rev:  1980000, ord:  366, uv:  9700, nb:  71, aRev: 2050000, aOrd:  380, aUv:  9900, aNb:  76 },
  { id: 'EV24149', c: '국내도서', n: '웹소설 원작 드라마 특집',      f: '로맨스',        md: '이지은', s: '2026-09-11', rev:  5120000, ord: 1180, uv: 19400, nb: 233, aRev: 2600000, aOrd:  610, aUv: 12800, aNb: 141 },
  { id: 'EV23902', c: '국내도서', n: '직장인 재테크 가이드',         f: '경제경영',      md: '최우식', s: '2026-08-30', rev:   980000, ord:  143, uv:  7600, nb:  26, aRev: 1120000, aOrd:  162, aUv:  8100, aNb:  31 },
  { id: 'EV24126', c: '국내도서', n: '과학 교양 큐레이션',           f: '인문',          md: '박서준', s: '2026-09-09', rev:   480000, ord:   66, uv:  5100, nb:  12, aRev:  610000, aOrd:   82, aUv:  5600, aNb:  16 },
  { id: 'EV24168', c: '국내도서', n: '힐링 그림에세이',              f: '에세이',        md: '김하늘', s: '2026-09-13', rev:  3260000, ord:  520, uv: 11900, nb:  96, aRev: 1480000, aOrd:  250, aUv:  7400, aNb:  52 },
  { id: 'EV23776', c: '국내도서', n: '무협 레전드 복간',             f: '판타지',        md: '정유미', s: '2026-08-18', rev:   330000, ord:   47, uv:  3100, nb:   5, aRev:  410000, aOrd:   58, aUv:  3500, aNb:   7 },
  { id: 'EV24099', c: '외국도서', n: '영어원서 입문 챌린지',         f: '외국어',        md: '최우식', s: '2026-09-03', rev:   210000, ord:   28, uv:  2400, nb:   6, aRev:  265000, aOrd:   34, aUv:  2700, aNb:   8 },
  { id: 'EV24113', c: '국내도서', n: '만화 단행본 100원 딜',         f: '만화/라노벨',   md: '정유미', s: '2026-09-07', rev:  7980000, ord: 3420, uv: 46700, nb: 520, aRev: 8600000, aOrd: 3680, aUv: 48200, aNb: 556 },
  { id: 'EV24101', c: '국내도서', n: '청소년 진로 필독서',           f: '어린이/청소년', md: '이지은', s: '2026-09-04', rev:   260000, ord:   33, uv:  4200, nb:   7, aRev:  310000, aOrd:   40, aUv:  4400, aNb:   9 },
  { id: 'EV23855', c: '국내도서', n: '심리학 스테디셀러',            f: '인문',          md: '박서준', s: '2026-08-26', rev:   420000, ord:   61, uv:  9800, nb:  11, aRev:  520000, aOrd:   72, aUv: 10400, aNb:  14 },
  { id: 'EV24185', c: '국내도서', n: '요리·살림 실용서전',           f: '실용',          md: '김하늘', s: '2026-09-15', rev:   620000, ord:   88, uv:  4900, nb:  19, aRev:  700000, aOrd:   96, aUv:  5200, aNb:  21 },
  { id: 'EV24193', c: '국내도서', n: 'SF 거장 컬렉션',               f: '판타지',        md: '정유미', s: '2026-09-16', rev:  4180000, ord:  690, uv: 13600, nb: 128, aRev: 1250000, aOrd:  215, aUv:  6300, aNb:  44 },
  { id: 'EV24201', c: '국내도서', n: '북토크 연계 신간전',           f: '소설',          md: '박서준', s: '2026-09-17', rev:  1340000, ord:  210, uv:  7200, nb:  48, aRev:       0, aOrd:    0, aUv:     0, aNb:   0 },
  { id: 'EV24202', c: '국내도서', n: '취업 자소서 완성',             f: '자기계발',      md: '김하늘', s: '2026-09-17', rev:   760000, ord:  118, uv:  5400, nb:  33, aRev:       0, aOrd:    0, aUv:     0, aNb:   0 },
  { id: 'EV23830', c: '국내도서', n: '여행 에세이 랜선여행',         f: '에세이',        md: '이지은', s: '2026-08-22', rev:   540000, ord:   78, uv: 12600, nb:  16, aRev:  680000, aOrd:   96, aUv: 13100, aNb:  21 },
  { id: 'EV24172', c: '국내도서', n: '재테크 유튜버 신작',           f: '경제경영',      md: '최우식', s: '2026-09-13', rev:  2980000, ord:  430, uv:  9200, nb:  78, aRev: 1900000, aOrd:  288, aUv:  7100, aNb:  56 },
  { id: 'EV24139', c: '국내도서', n: '고전문학 무료 체험',           f: '소설',          md: '박서준', s: '2026-09-10', rev:  1180000, ord:  260, uv: 10400, nb:  42, aRev: 1260000, aOrd:  274, aUv: 10800, aNb:  46 },
  { id: 'EV23891', c: '국내도서', n: '데이터 분석 입문서전',         f: 'IT',            md: '최우식', s: '2026-08-29', rev:  1620000, ord:  205, uv:  5300, nb:  35, aRev: 1540000, aOrd:  196, aUv:  5150, aNb:  33 },
  { id: 'EV24220', c: '외국도서', n: '영어 그림책 원서 세트',        f: '어린이/청소년', md: '이지은', s: '2026-09-09', rev:   760000, ord:   96, uv:  4800, nb:  24, aRev:  820000, aOrd:  104, aUv:  5100, aNb:  27 },
  { id: 'EV24225', c: '외국도서', n: '해외 원서 베스트 직수입',      f: '소설',          md: '박서준', s: '2026-09-11', rev:  1420000, ord:  138, uv:  6200, nb:  41, aRev: 1180000, aOrd:  118, aUv:  5600, aNb:  35 },
  { id: 'EV24210', c: '음반,DVD', n: '가을 클래식 명반 기획전',      f: '클래식',        md: '정유미', s: '2026-09-06', rev:  1840000, ord:  220, uv:  6800, nb:  41, aRev: 1720000, aOrd:  205, aUv:  6400, aNb:  38 },
  { id: 'EV24215', c: '음반,DVD', n: 'K-POP 컴백 앨범 예약',         f: '가요',          md: '이지은', s: '2026-09-12', rev:  6420000, ord:  980, uv: 24600, nb: 312, aRev: 4100000, aOrd:  640, aUv: 18200, aNb: 205 },
  { id: 'EV23940', c: '음반,DVD', n: '영화 블루레이 소장전',         f: 'DVD',           md: '최우식', s: '2026-08-25', rev:   380000, ord:   44, uv:  3600, nb:   8, aRev:  450000, aOrd:   52, aUv:  3900, aNb:  10 },
  { id: 'EV24188', c: 'GIFT',     n: '가을 다이어리 예약판매',        f: '문구',          md: '김하늘', s: '2026-09-14', rev:  2260000, ord:  410, uv:  9800, nb:  96, aRev: 1980000, aOrd:  360, aUv:  9100, aNb:  88 },
  { id: 'EV24205', c: 'GIFT',     n: '텀블러·머그 기획전',            f: '리빙',          md: '박서준', s: '2026-09-16', rev:   940000, ord:  160, uv:  5200, nb:  44, aRev:  620000, aOrd:  108, aUv:  4100, aNb:  30 },
  { id: 'EV23915', c: 'GIFT',     n: '캐릭터 굿즈 상설전',            f: '캐릭터',        md: '정유미', s: '2026-08-27', rev:   420000, ord:   62, uv:  7900, nb:  12, aRev:  520000, aOrd:   74, aUv:  8300, aNb:  15 }
];

/* 이벤트 등록 화면의 대분류 코드 — 성과는 대분류 단위로 따로 비교한다 */
const CATEGORIES = ['국내도서', '외국도서', '음반,DVD', 'GIFT', 'eBook'];
...
/* ---------------------------------------------------------
   집계
   --------------------------------------------------------- */
function buildReport(baseDate, filterCat, filterField, filterMd) {
  // 1) 집계 대상 — 진행 중 + 조회 조건(대분류·분야·담당자)이 곧 비교 모집단이 된다
  const running = EVENTS.filter(e =>
    (!filterCat || e.c === filterCat) &&
    (!filterField || e.f === filterField) &&
    (!filterMd || e.md === filterMd)
  ).map(e => {
...
function openDrawer(id) {
  ...
  $('#drawerPills').innerHTML = `
    <span class="pill pill-cat">${esc(e.c)}</span>
...
/* ---------------------------------------------------------
   드로어 마크업 주입 + 공통 바인딩
   두 화면(데일리 리포트 / 성과 조회)이 같은 드로어를 쓴다.
   --------------------------------------------------------- */
const DRAWER_HTML = `
...
<aside class="drawer" id="drawer" role="dialog" aria-modal="true" aria-labelledby="drawerTitle">
  <header class="drawer-head">
    <div class="drawer-head-top">
      ...
      <button class="drawer-close" id="drawerClose" title="닫기 (ESC)" aria-label="닫기">
  ...
  <footer class="drawer-foot">
    <a class="btn btn-outline btn-sm" id="drawerLink" href="#">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
      이벤트 랜딩 바로가기
    </a>
    <span class="spacer"></span>
    <button class="btn btn-primary btn-sm" id="drawerCloseBtn">닫기</button>
  </footer>
</aside>`;

document.addEventListener('DOMContentLoaded', () => {
  if (!$('#drawer')) document.body.insertAdjacentHTML('beforeend', DRAWER_HTML);

  // 이벤트명 / "이벤트 상세 보기" 버튼 → 드로어 (화면 이동 없음)
