...
(function(w) {
    ...
    try {
        var links = ["https:\/\/cm.g.doubleclick.net\/pixel?google_nid=wider_planet\u0026google_cm\u0026google_ula=12153253,1780830704\u0026poaid=e64945d051c72ed90cbaeedca593d7e8"],
            len = links.length,
            i;
        for (i=0; i<len; i++) {
            doPair(links[i]);
...
(function(w) {
    ...
    try {
        doPair("https:\/\/astg.widerplanet.com\/delivery\/storage?request_id=null\u0026wp_uid=2-e64945d051c72ed90cbaeedca593d7e8-s1710332328.912459%7Cwindows_10%7Cchrome-evrkje\u0026qsc=1cnp7to");
    } catch(e) {}
})(window);
/*]]>*/
...
(function(w) {
    try {
        ...
        identity.setCookie('_wp_uid', "1-e64945d051c72ed90cbaeedca593d7e8-s1710332328.912459|windows_10|chrome-zoi5z7", 365);
